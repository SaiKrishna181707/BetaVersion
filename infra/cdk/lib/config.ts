...
export function loadConfig(environment: NodeJS.ProcessEnv = process.env): BetaVersionConfig {
  ...
  return {
    ...
    amplify_branch: environment.BETAVERSION_AMPLIFY_BRANCH ?? 'feat/product-foundation',
    ...
    nova_act_requirement: environment.BETAVERSION_NOVA_ACT_REQUIREMENT ?? 'nova-act==3.4.187.0',
